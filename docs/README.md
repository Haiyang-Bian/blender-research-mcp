...
2. [Using Blender Research MCP](usage.md) — current 0.10.0 operator workflow and error
   recovery.
...
Version 0.10.0 adds exact ordered Modifier-stack inspection plus create, typed set,
